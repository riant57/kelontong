...
class Ajax_pagination{
    ...
    var $next_link       = '<div class="btn-flat blue white-text center waves-effect waves-light" style="border-radius: 0px;"><i class="material-icons">arrow_forward</i></div>';
    var $prev_link       = '<span class="btn-flat blue white-text center  waves-effect waves-light" style="border-radius: 0px;"><i class="material-icons">arrow_back</i></span>';
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<div class="bottom-navigation responsive-container" style="text-align:right">';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            ...
            return "<div class='bottom-navigation responsive-container' style='text-align:right'><span class='bottom-navigation-content'>".$info."</span></div>";;
        }
        ...
        if ($this->show_count){
            ...
            $info .= ' / ' . $this->total_rows . ' &nbsp; &nbsp;';
            $output .= "<span class='bottom-navigation-content'>".$info."</span>";
        }
