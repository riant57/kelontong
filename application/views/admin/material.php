				...
				<tbody>
					...
					<tr>
						...
						<td style="text-align: center;">
							...
							<a onclick="delete_material(<?php echo $item['id']; ?>)" class="waves-effect waves-blue red btn-menu">Hapus</a>
						</td>
					</tr>
					<?php  endforeach; else: ?>
						<tr><td colspan="3">Material(s) not available.</td></tr>
					<?php endif; ?>	
				</tbody>
	    	...
	    	<form action="#" id="form" onsubmit="return false">
				...
				<div class="row">
					<div class="input-field col s12">
					  <input placeholder="Bahan Baku" name="name" id="first_name" type="text" class="validate">
					  <label for="first_name">Nama Kategori</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
					  <input placeholder="Jumlah" name="quantity" id="first_name" type="number" class="validate">
...
?>
<script src="<?php echo $this->config->item('base_url') ?>assets/js/material.js"></script>
<script>
