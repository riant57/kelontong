	...
	<div id="tambah_form" class="custom-modal responsive-container">
		<nav class="blue">
		    <div class="nav-wrapper blue">
		      ...
		      <a href="#!" class="custom-nav-title">Tambah Pelanggan</a>
		    </div>
		  </nav>
	    	...
	    	<form action="#" id="form" onsubmit="return false">
				...
				<div class="row">
					<div class="input-field col s12">
					  <input placeholder="Nama Pelanggan" name="name" id="first_name" type="text" class="validate">
					  <label for="first_name">Nama Pelanggan</label>
					</div>
					<div class="input-field col s12">
					  <input placeholder="Alamat" name="address" id="" type="text" class="validate">
					  <label for="first_name">Alamat</label>
					</div>
					<div class="input-field col s12">
					  <input placeholder="Telepon" name="phone" id="" type="text" class="validate">
					  <label for="first_name">Telepon</label>
					</div>
				</div>
				<div class="bottom-navigation responsive-container" style="position: absolute;">
				    <a href="javascript:void(0)" id="btnSave" onclick="save()" class="btn-flat green white-text waves-effect waves-light">SIMPAN</a>
				</div>
		    </form>
	    </div>
	</div>
...
?>
<script src="<?php echo $this->config->item('base_url') ?>assets/js/members.js"></script>
<script>
