	...
	<div id="tambah_form" class="custom-modal responsive-container">
		<nav class="blue">
		    <div class="nav-wrapper blue">
		      ...
		      <a href="#!" class="custom-nav-title">Tambah Supplier</a>
		    </div>
		  </nav>
	    	...
	    	<form action="#" id="form" onsubmit="return false">
				...
				<div class="row">
					<div class="input-field col s12">
					  <input placeholder="Nama Supplier" name="name" id="first_name" type="text" class="validate">
					  <label for="first_name">Nama Supplier</label>
					</div>
					<div class="input-field col s12">
					  <input placeholder="Nama Pemilik" name="owner" id="" type="text" class="validate">
...
?>
<script src="<?php echo $this->config->item('base_url') ?>assets/js/suppliers.js"></script>
<script>
