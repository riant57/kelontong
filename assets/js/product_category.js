...
function edit_category(id)
{
    ...
    $.ajax({
        url :  base_url+"category/ajax_edit/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        ...
        url = base_url+"category/ajax_update";
    }
...
function delete_category(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : base_url+"category/ajax_delete/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function searchFilter(page_num) {
	...
	$.ajax({
		type: 'POST',
		url: base_url+'category/ajaxPaginationData/'+page_num,
